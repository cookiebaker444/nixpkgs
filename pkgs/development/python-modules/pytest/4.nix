...
, setuptools_scm, setuptools, six, pluggy_0, funcsigs, isPy3k, more-itertools
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ attrs py setuptools six pluggy_0 more-itertools atomicwrites wcwidth packaging ]
